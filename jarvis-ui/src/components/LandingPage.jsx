...
const LandingPage = () => {
  ...
  return (
    ...
    >
      ...
      {/* Features Section with Scrolling */}
      <section
        style={{
          padding: "60px 20px",
      ...
      >
        ...
        {features.map((feature, index) => {
          ...
          const imagePath = `/images/${feature.title.toLowerCase().replace(/ /g, '-')}.jpg`;
          ...
          return (
            <div
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 0 25px rgba(0, 183, 235, 0.5)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "scale(1)";
                e.currentTarget.style.boxShadow = "0 0 15px rgba(0, 183, 235, 0.3)";
              }}
            >
              <img
                src={imagePath}
